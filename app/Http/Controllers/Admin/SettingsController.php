...
class SettingsController extends Controller
{
    ...
    public function updateHeroImages(Request $request)
    {
        $validated = $request->validate([
            ...
            'bim_page_images' => 'nullable|array',
            'bim_page_images.*' => 'image|max:5120',
            ...
            'estimation_page_images' => 'nullable|array',
            'estimation_page_images.*' => 'image|max:5120',
