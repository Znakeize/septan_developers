...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .file-name { margin-top: 10px; font-size: 0.9rem; color: #dc2626; word-break: break-all; }
...
<body>
        ...
        <main class="main-content">
            <div class="form-container">
                <div class="form-header">
                    <h1>ADD <span style="color: #ffffffff;">NEW</span> BLOG</h1>
    ...
    @csrf
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" id="title" name="title" placeholder="Blog Title" value="{{ old('title') }}" required>
                    ...
                    <div class="form-row">
                        <div class="form-group input-group">
                            ...
                            <select id="category" name="category" required>
                                ...
                                <option value="Interior Design" {{ old('category') == 'Interior Design' ? 'selected' : '' }}>Interior Design</option>
                    ...
                    <div class="form-group input-group full-width">
                        ...
                        <textarea id="excerpt" name="excerpt" required placeholder="Brief summary of the article (max 500 characters)">{{ old('excerpt') }}</textarea>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="drop-zone" id="blog-drop-zone">
                            ...
                            <input type="file" id="featured_image" name="featured_image" accept="image/*,.docx,.pdf" required>
                    ...
                    <div class="form-group input-group">
                        ...
                        <input type="text" id="tags" name="tags" value="{{ old('tags') }}" placeholder="design, architecture, sustainability">
    ...
    <script>
        ...
        function handleFiles(files) {
            ...
            if (['png', 'jpg', 'jpeg', 'webp'].includes(ext)) {
                ...
                // Only accept image for featured_image field
